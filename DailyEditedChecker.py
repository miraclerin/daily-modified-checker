...
class DailyEditedChecker():
    ...
    def run(self):
        ...
        for i in to_check:
            self.write_date_in_database(i, self.get_file_day_when_edited(i))
    ...
    def get_file_day_when_edited(self, file_path):
